<div class="card card-secondary">
  <div class="card-header">
    <h3 class="card-title"><i class="fa fa-file"></i> Laporan Kas Gereja Efrata</h3>
  </div>
  <form action="./report/kas_efrata_per.php" method="post" enctype="multipart/form-data" target="_blank">
    <div class="card-body">
    ...
    <div class="card-footer">
      ...
      <a href="./report/kas_efrata_full.php" class="btn btn-primary" target="_blank">Cetak Semua</a>
    </div>
  </form>
</div>
