...
<?php
  $sql = $koneksi->query("SELECT SUM(masuk) as tot_masuk  from dana_kas where jenis='Masuk' order by tgl_kas desc");
  ...
  <table border="1" cellspacing="0">
    ...
    <tbody>
        <?php
            ...
            $no=1;
            $sql_tampil = "select * from dana_kas order by tgl_kas desc";
